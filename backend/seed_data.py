...
def seed_database(db):
    ...
    if not demo_user:
        demo_user = models.User(
            ...
            date_of_birth=datetime(1998, 5, 20, tzinfo=timezone.utc),
    ...
    owners_data = [
        ...
        },
        {
            ...
            "date_of_birth": datetime(1994, 9, 8, tzinfo=timezone.utc),
        ...
        },
        {
            ...
            "date_of_birth": datetime(1999, 11, 23, tzinfo=timezone.utc),
        ...
        },
        {
            ...
            "date_of_birth": datetime(1993, 2, 17, tzinfo=timezone.utc),
        ...
        },
        {
            ...
            "date_of_birth": datetime(1997, 7, 5, tzinfo=timezone.utc),
        ...
        },
        {
            ...
            "date_of_birth": datetime(1995, 8, 30, tzinfo=timezone.utc),
    ...
    for o_data in owners_data:
        ...
        if not user:
            user = models.User(
                ...
                hash_pass=hash_password("password123"),
                rol=models.Role.OWNER,
                date_of_birth=o_data["date_of_birth"],
