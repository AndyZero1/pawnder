        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Stack(
                ...
                children: [
                  CircleAvatar(
                    ...
                    backgroundImage: pozaAnimalBytes != null ? MemoryImage(pozaAnimalBytes!) : null,
                    child: pozaAnimalBytes == null ? const Icon(Icons.pets, size: 40, color: Colors.grey) : null,
                  ),
                  GestureDetector(
                    onTap: () async {
              ...
              _buildInputField('Specie', 'Ex: Câine, Pisică', specieController),
              _buildInputField('Rasă', 'Ex: Golden Retriever', rasaController),
              Row(
                children: [
                  Expanded(child: _buildInputField('Vârstă (ani)', 'Ex: 3', varstaController, isNumber: true)),
                  const SizedBox(width: 15),
                  Expanded(child: _buildInputField('Greutate (kg)', 'Ex: 15', greutateController, isNumber: true)),
                ],
              ),
              const SizedBox(height: 20),
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.pop(context, {
                      'nume': numeController.text.isEmpty ? 'Fără Nume' : numeController.text,
                      'rasa': rasaController.text.isEmpty ? 'Necunoscută' : rasaController.text,
                      'specie': specieController.text.isEmpty ? 'Necunoscută' : specieController.text,
                      'varsta': varstaController.text.isEmpty ? '0' : varstaController.text,
                      'greutate': greutateController.text.isEmpty ? '0' : greutateController.text,
                      'pozaUrl': 'https://images.unsplash.com/photo-1543852786-1cf6624b9987?auto=format&fit=crop&w=500&q=80',
                  ...
                  child: const Text('Adaugă Animalul', style: TextStyle(fontSize: 18, color: Colors.white)),
                ),
              ),
            ],
          ),
        ...
        children: [
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(8), borderSide: const BorderSide(color: Color(0xFF1F6E6C))),
            ),
          ),
        ],
      ),
