...
class _EditProfileDialogState extends State<EditProfileDialog> {
  ...
  void initState() {
    ...
    usernameController = TextEditingController(text: widget.currentInfo['username']);
    ...
    dataNasteriiController = TextEditingController(text: widget.currentInfo['dataNasterii']);
  ...
  ImageProvider _getProfileImage() {
    if (pozaNouaBytes != null) {
      return MemoryImage(pozaNouaBytes!);
    }
    return NetworkImage(widget.currentInfo['pozaUrl']);
  }
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildInputField('Nume Complet', 'Ex: Nume Prenume', numeController, null, isRequired: true),
              _buildInputField('Username', '@username', usernameController, null, isRequired: true),
              _buildInputField('Descriere (Bio)', 'Scrie ceva despre tine', bioController, null, maxLines: 3),
              _buildInputField('E-mail', 'example123@gmail.com', emailController, Icons.email_outlined, isRequired: true),
              _buildInputField('Data nașterii', 'ZZ/LL/AAAA', dataNasteriiController, Icons.calendar_today_outlined, isRequired: true, readOnly: true, onTap: () => _selecteazaData(context)),
              const SizedBox(height: 20),
              SizedBox(
      ...
      child: Column(
        ...
        children: [
          ...
          if (isRequired) ...[
            ...
            const Text('* Acest câmp este obligatoriu', style: TextStyle(color: Colors.grey, fontSize: 11)),
          ],
        ],
      ),
    );
