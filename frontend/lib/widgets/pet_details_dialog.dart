...
class _PetDetailsDialogState extends State<PetDetailsDialog> {
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  _buildEditableInfoBox('Age', varstaController, 'yrs'),
                  _buildEditableInfoBox('Weight', greutateController, 'kg'),
                  _buildInfoBox(
                    'Species',
                    widget.pet['specie'] ?? '-',
                  ), 
                ...
                onPressed: () {
                  showDialog(
                    ...
                    builder: (context) => AlertDialog(
                      ...
                      content: Text(
                        'Are you sure you want to delete the profile of ${widget.pet['nume']}?',
                      ),
                      actions: [
                        TextButton(
                          onPressed: () => Navigator.pop(context),
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                Text(
                  'Add a PDF using the button above',
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                const SizedBox(height: 4),
                Text(
                  'Add a vaccination using the button above',
                  style: TextStyle(color: Colors.grey[400], fontSize: 12),
                ),
              ],
            ),
                    ...
                    child: Padding(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            // vaccine name + status badge + delete
                            Row(
                              children: [
  ...
  _VaccinStatus _getVaccinStatus(String? dataRapelStr) {
    if (dataRapelStr == null || dataRapelStr.isEmpty) {
      return _VaccinStatus('No booster', Colors.grey);
    }
    try {
      ...
      if (diferenta < 0) {
        return _VaccinStatus('Expired', Colors.red);
      } else if (diferenta <= 30) {
        return _VaccinStatus('Expiring soon', Colors.orange);
      } else {
        return _VaccinStatus('Valid', const Color(0xFF2ECC40));
      }
    } catch (_) {
      return _VaccinStatus('Unknown', Colors.grey);
    }
  }
}
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          'Full PDF viewing will be available with backend integration.',
                          textAlign: TextAlign.center,
                          style: TextStyle(
                            fontSize: 12,
                            color: Colors.grey[500],
