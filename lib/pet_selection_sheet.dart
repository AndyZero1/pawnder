      ...
      return Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Who are you bringing to the event?', 
            ...
            if (userPets.isEmpty)
               const Text(
                 'You have not added any pets to your profile yet.', 
              ...
              ...userPets.map((pet) => Card(
                ...
                child: ListTile(
                  ...
                  title: Text(pet['nume'] ?? 'Unknown Name', style: const TextStyle(fontWeight: FontWeight.bold)),
