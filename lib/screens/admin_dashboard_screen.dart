...
class _AdminDashboardScreenState extends State<AdminDashboardScreen> with SingleTickerProviderStateMixin {
  ...
  // --- VERIFICATION REQUESTS (Pending clinics) ---
  ...
  // --- MODERATION: REPORTED ANNOUNCEMENTS ---
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color(0xFFFCDCE0), // Pawnder specific pink background
      body: SafeArea(
        child: Column(
          children: [
            // --- HEADER ---
            Container(
              ...
              child: Column(
                children: [
                  ...
                  // Tabs matching Jira ticket requirements (Requests & Moderation)
                  TabBar(
  ...
  Widget _buildModerareTab() {
    return SingleChildScrollView(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          // Section 1: Reported Announcements
          const Row(
            children: [
