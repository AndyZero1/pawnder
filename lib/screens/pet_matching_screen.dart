  ...
  final List<Map<String, dynamic>> pets = [
    {
      ...
      'location': 'Bucharest',
      'description':
          'Max is very friendly and loves long walks.',
      'petImage':
    ...
    },
    {
      ...
      'location': 'Bucharest',
      'description':
          'Luna is calm, curious and loves human company.',
      'petImage':
    ...
    },
    {
      ...
      'location': 'Ilfov',
      'description':
          'Rocky is energetic, social and always ready for an adventure.',
      'petImage':
    ...
    },
    {
      ...
      'location': 'Bucharest',
      'description':
          'Milo is gentle and very attached to people.',
      'petImage':
    ...
    },
    {
      ...
      'location': 'Pipera',
      'description':
          'Bella loves people and playing outdoors.',
      'petImage':
            ...
            Expanded(
              child: LayoutBuilder(
                builder: (context, constraints) {
                  ...
                  // Adaptive card height based on actual screen height - guaranteed no overflow
